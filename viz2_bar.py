...
# --- Data prepared already in `cty` (sorted ascending by spp) ---
...
# Rank by values (descending) to build tier palette.
...
# --- Layout: top insight card + bottom ranking chart ---
...
# Title + subtitle (centered, editorial).
fig.text(
    0.5,
    0.965,
...
# Tier bands for analytical structure (very subtle).
...
# Reference line: provincial median.
...
# Dark, bold axis tick labels + marks.
...
# Thick black outer border around the chart area.
...
# Value labels: stronger for Avalon + top tier, understated elsewhere.
...
# Avalon insight card on top (integrated).
