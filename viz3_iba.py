...
CAT_COLORS = {
    # Coordinated, restrained palette (colorblind-friendlier than saturated rainbow).
    "Seabirds": "#4c78a8",
    "Waterfowl": "#72b7b2",
    "Shorebirds": "#f2cf5b",
    "Raptors": "#b279a2",
...
# Clean label wrapping for long site names.
def wrap_label(s):
    if len(s) <= 22:
        return s
    cut = s.rfind(" ", 0, 22)
...
# Subtle row shading improves scanability without adding clutter.
...
# Keep ranking and totals easy to read.
...
# Analytical structure: median reference line.
...
# Integrated legend near title area (not detached in corner).
...
# Insight-driven title/subtitle hierarchy.
fig.text(
    0.5,
    0.965,
...
# Story annotation integrated with the top site.
...
# Minimal axis styling (avoid default matplotlib look).
...
# Thick black outer border around the full chart area.
